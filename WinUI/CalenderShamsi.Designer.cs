...
namespace WinUI
{
    partial class CalenderSHamsi
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnToday = new WinUI.CalendarMonthButton();
            this.btnNextYear = new WinUI.CalendarYearButton();
            this.btnNextMonth = new WinUI.CalendarMonthButton();
            this.btnBackMonth = new WinUI.CalendarMonthButton();
            this.btnBackYear = new WinUI.CalendarYearButton();
