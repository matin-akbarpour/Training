...
namespace SaminControl
{
	/// <summary>
	/// A replacement for the Windows Button Control.
	/// </summary>
	[DefaultEvent("Click")]
	public class SaminButton : System.Windows.Forms.UserControl
	{
        ...
        private void InitializeComponent()
        {
            ...
            // SaminButton
            // 
            this.Name = "SaminButton";
            this.Size = new System.Drawing.Size(100, 32);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.SaminButton_Paint);
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.SaminButton_KeyUp);
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.SaminButton_KeyPress);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.SaminButton_KeyDown);
            this.MouseEnter += new System.EventHandler(this.SaminButton_MouseEnter);
            this.MouseLeave += new System.EventHandler(this.SaminButton_MouseLeave);
            this.MouseUp += new MouseEventHandler(SaminButton_MouseUp);
            this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.SaminButton_MouseDown);
            this.GotFocus += new EventHandler(SaminButton_MouseEnter);
            this.LostFocus += new EventHandler(SaminButton_MouseLeave);
            this.mFadeIn.Tick += new EventHandler(mFadeIn_Tick);
            this.mFadeOut.Tick += new EventHandler(mFadeOut_Tick);
            this.Resize += new EventHandler(SaminButton_Resize);
        }
        ...
        private Color mHighlightColor = Color.FromArgb(185, 209, 234);
        /// <summary>
        ...
        private Color mButtonColor = Color.FromArgb(244, 247, 252);
        /// <summary>
        ...
        private Color mGlowColor = Color.FromArgb(153, 180, 209);
        /// <summary>
        ...
        private Color mBaseColor = Color.FromArgb(244, 247, 252);
        /// <summary>
        ...
        private void DrawText(Graphics g)
        {
            ...
            Rectangle r = new Rectangle(4, 4, this.Width - 8, this.Height - 5);
            if (!this.Enabled)
            {
                g.DrawString(this.Text, new Font("B Yekan", (float)9.75), new SolidBrush(Color.Silver), r, sf);
            }
            else
            {
                g.DrawString(this.Text, new Font("B Yekan", (float)9.75), new SolidBrush(this.ForeColor), r, sf);
            }
        }
        ...
        private void SaminButton_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void SaminButton_Resize(object sender, EventArgs e)
        {
            Rectangle r = this.ClientRectangle;
            r.X -= 1; r.Y -= 1;
        ...
        private void SaminButton_MouseEnter(object sender, EventArgs e)
        {
        ...
        private void SaminButton_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void SaminButton_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void SaminButton_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                MouseEventArgs m = new MouseEventArgs(MouseButtons.Left, 0, 0, 0, 0);
                SaminButton_MouseDown(sender, m);
            }
        }

        private void SaminButton_KeyUp(object sender, KeyEventArgs e)
        {
            //if (e.KeyCode == Keys.Enter)
            //{
            //    MouseEventArgs m = new MouseEventArgs(MouseButtons.Left, 0, 0, 0, 0);
            //    calledbykey = true;
            //    SaminButton_MouseUp(sender, m);
            //}
        }
        private void SaminButton_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((int)e.KeyChar == 13)
            {
                MouseEventArgs m = new MouseEventArgs(MouseButtons.Left, 0, 0, 0, 0);
                ...
                SaminButton_MouseDown(sender, m);
                SaminButton_MouseUp(sender, m);
                //Form  str=((SaminButton)sender).ParentForm;
        ...
        private void SaminButton_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                mButtonState = State.Hover;
